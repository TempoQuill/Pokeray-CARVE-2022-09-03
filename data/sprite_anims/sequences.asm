...
; entries correspond to SPRITE_ANIM_INDEX_* constants
	...
	db SPRITE_ANIM_FRAMESET_RS_INTRO_HELICELIA,        SPRITE_ANIM_SEQ_RS_INTRO_HELICELIA,          $00 ; SPRITE_ANIM_INDEX_RS_INTRO_EYE
	db SPRITE_ANIM_FRAMESET_RS_INTRO_HELICELIA,        SPRITE_ANIM_SEQ_RS_INTRO_HELICELIA,          $00 ; SPRITE_ANIM_INDEX_RS_INTRO_PAW
	db SPRITE_ANIM_FRAMESET_RS_INTRO_HELICELIA,        SPRITE_ANIM_SEQ_RS_INTRO_HELICELIA,          $00 ; SPRITE_ANIM_INDEX_RS_INTRO_TAIL
