...
; main campaign events
	...
	const EVENT_RIVALS_MOM_GIVES_TOWN_MAP
	const EVENT_MET_RIVAL_AT_TRAVERSAL
	const EVENT_GRAMPS_MAP_CARD
; item balls
	const EVENT_BALL_ORKID
	const EVENT_BALL_FLAMBEAR
	const EVENT_BALL_CRUZ
	const EVENT_ROUTE_49_POTION
	const EVENT_ROUTE_49_ANTIDOTE             ; 28
	const EVENT_ROUTE_51_PARALYZEHEAL
; hidden items
	const EVENT_ROUTE_50_HIDDEN_BURN_HEAL
	const EVENT_ROUTE_51_HIDDEN_POTION
	const EVENT_FOLIAGE_HIDDEN_HYPER_POTION
; people
...
; Mt Vacuum
	const EVENT_MT_VACUUM_PARALYZEHEAL        ; 30
	const EVENT_MT_VACUUM_HIDDEN_NIGHT_ARMOR
	const EVENT_MT_VACUUM_BUDDING_SEED
	const EVENT_MT_VACUUM_HIDDEN_FIRE_STONE
	const EVENT_MT_VACUUM_POKE_BALL
	const EVENT_MT_VACUUM_NUGGET_1
	const EVENT_MT_VACUUM_HIDDEN_WATER_STONE
	const EVENT_MT_VACUUM_NUGGET_2
	const EVENT_MT_VACUUM_HIDDEN_STROBE_LIGHT ; 38
	const EVENT_MT_VACUUM_HIDDEN_SUPER_POTION
	const EVENT_MT_VACUUM_HIDDEN_FULL_HEAL
